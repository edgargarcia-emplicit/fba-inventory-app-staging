...
Ask Claude for the change you want
Paste the updated file into GitHub → pencil icon → Commit changes
The live app updates itself within about a minute
If something breaks: GitHub → History on that file → restore the
previous version
